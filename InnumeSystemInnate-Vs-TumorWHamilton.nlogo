...
to-report neutrophils-to-recruit
  report gauss recruit-neutrophils
end

to-report macrophages-to-recruit
  report gauss recruit-macrophages
end

to-report natural-killers-to-recruit
  report gauss recruit-natural-killers
end
...
; recruit of innate immune system cells
  ...
  create-neutrs neutrophils-to-recruit [ neutrs-cells setxy x 32 set age 0 ]


    let y cordinates 1 -1
  ;create-natuks recruit-natural-killers [ natuks-cells setxy min-pxcor random-ycor set age 0 ]
  create-natuks natural-killers-to-recruit [ natuks-cells setxy 0 y set age 0 ]

  set x cordinates -1 1
  ;create-macros recruit-macrophages [ macros-cells setxy random-xcor min-pycor set age 0 ]
  create-macros macrophages-to-recruit [ macros-cells setxy x 0 set age 0 ]
...
; recruit of innate immune system cells
   let x cordinates 1 1
  ;create-neutrs recruit-neutrophils [ neutrs-cells setxy random-xcor max-pycor set age 0 ]
  create-neutrsb neutrophils-to-recruit [ neutrs-cells setxy x 32 set age 0 ]
...
; recruit of innate immune system cells
   let x cordinates -1 1
  ;create-neutrs recruit-neutrophils [ neutrs-cells setxy random-xcor max-pycor set age 0 ]
  create-neutrsLg neutrophils-to-recruit [ neutrs-cells setxy x -32 set age 0 ]


    let y cordinates -1 -1
  ;create-natuks recruit-natural-killers [ natuks-cells setxy min-pxcor random-ycor set age 0 ]
  create-natuksLg natural-killers-to-recruit [ natuks-cells setxy 0 y set age 0 ]

  set x cordinates -1 1
  ;create-macros recruit-macrophages [ macros-cells setxy random-xcor min-pycor set age 0 ]
  create-macrosLg macrophages-to-recruit [ macros-cells setxy x 0 set age 0 ]
...
; recruit of innate immune system cells
   let x cordinates 1 1
  ;create-neutrs recruit-neutrophils [ neutrs-cells setxy random-xcor max-pycor set age 0 ]
  create-neutrsLv neutrophils-to-recruit [ neutrs-cells setxy x -32 set age 0 ]


    let y cordinates -1 -1
  ;create-natuks recruit-natural-killers [ natuks-cells setxy min-pxcor random-ycor set age 0 ]
  create-natuksLv natural-killers-to-recruit [ natuks-cells setxy 0 y set age 0 ]

  set x cordinates 1 1
  ;create-macros recruit-macrophages [ macros-cells setxy random-xcor min-pycor set age 0 ]
  create-macrosLv macrophages-to-recruit [ macros-cells setxy x 0 set age 0 ]
